...
$check_tmp = mysql_num_rows(mysql_query("SELECT * FROM koweb_auth_sms WHERE check_phone = '$data_send'"));
if($check_tmp > 0){
	$del_check = mysql_query("DELETE FROM koweb_auth_sms WHERE check_phone = '$data_send'");
}

$insert_ = "INSERT INTO koweb_auth_sms VALUES('' , '$data_send' , '$check_code', 'Y')";
$insert_result = mysql_query($insert_);
