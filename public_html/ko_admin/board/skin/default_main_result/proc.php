...
$withIn5_=$_POST[withIn5];
$withIn5 = "";
foreach($withIn5_ as $value){
	$withIn5 .= $value."^";
}
$withIn5s=substr($withIn5, 0, -1);

$withIn3_=$_POST[withIn3];
$withIn3 = "";
foreach($withIn3_ as $value){
	$withIn3 .= $value."^";
}
$withIn3s=substr($withIn3, 0, -1);
...
if($mode == "modify"){
	...
	alert("수정되었습니다.");
	url($return_url[0]."?board_id=$board_id&amp;mode=modify&amp;no=$no&amp;start=$start");
