...
if($mode == "modify"){
	...
	$check_ = mysql_fetch_array(mysql_query("SELECT * FROM $board_id WHERE ref_no='$ref_no' AND depth > 0 ORDER BY ref_group DESC LIMIT 1"));
	...
	mysql_query("UPDATE $board_id SET ref_no = '$ref_no' WHERE no='$ref_no' LIMIT 1");
