...
$chart_category_=$_POST[chart_category];
$chart_category="";
foreach($chart_category_ as $value){
	$chart_category .= $value."^";
}
$chart_categorys=substr($chart_category, 0, -1);

$contents_01_=$_POST[contents_01];
$contents_01 = "";
foreach($contents_01_ as $value){
	$contents_01 .= $value."^";
}
$contents_01s=substr($contents_01, 0, -1);

$contents_02_=$_POST[contents_02];
$contents_02 = "";
foreach($contents_02_ as $value){
	$contents_02 .= $value."^";
}
$contents_02s=substr($contents_02, 0, -1);
...
if($mode == "modify"){
	...
	$update_query = "UPDATE $board_id SET id='$_SESSION[member_id]',
											...
											hidden='$hidden',
											chart_category='$chart_categorys',
											contents_01='$contents_01s',
											contents_02='$contents_02s',
											kor_title='$kor_title',
											fund_department='$fund_department',
											begin_period='$begin_period',
											end_period='$end_period',
											leader='$leader',
											manager='$manager',
											role='$role',
											chk_ongoing='$chk_ongoing',
											link='$link'
										WHERE no='$no' LIMIT 1";
