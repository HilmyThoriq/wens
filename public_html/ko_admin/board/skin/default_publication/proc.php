...
// 카테고리 분류 위한 날짜 분할
$for_cate = explode("-", $publ_date);
$publ_date_Y = $for_cate[0];
$publ_date_M = $for_cate[1];
$publ_date_D = $for_cate[2];
...
$filled_ack_=$_POST[filled_ack];
$filled_ack = "";
foreach($filled_ack_ as $value){
	$filled_ack .= $value."^";
}
$filled_acks=substr($filled_ack, 0, -1);
...
if($mode == "modify"){
	...
	$update_query = "UPDATE $board_id SET id='$_SESSION[member_id]',
											...
											volume='$volume',
											type_publ='$type_publ',
											number_publ='$number_publ',
											s_page='$s_page',
											e_page='$e_page',
											impact_factor='$impact_factor',
											filled_ack='$filled_acks',
											publ_date='$publ_date',
