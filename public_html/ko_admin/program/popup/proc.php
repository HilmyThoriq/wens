...
if($mode == "modify_proc"){
	...
	mysql_query("INSERT INTO $program_table VALUES ('', '$title', '$popup_type', '$contents', '$title_img', '$link_url','$link_type', '$start_date', '$end_date', '$state', '$width', '$height', '$zindex', '$position_width', '$position_height', '$reg_date')");
